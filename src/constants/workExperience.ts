...
const liasonCreative = {
  subtitle: "UI Developer / UX Designer",
  title: "Liaison Creative + Marketing",
  metadata: "Jun 2016 - Oct 2018",
  description: [
...
export const WORK_EXPERIENCE: Detail[] = [
  iterable,
  rapidDeploy,
  nxpSemiconductors,
  liasonCreative,
